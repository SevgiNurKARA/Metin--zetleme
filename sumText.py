...
df = pd.read_csv('test.csv')    #11k tane veri
...
# Generating the summaries for the first 3000 articles
summaries = article_summarize(df['article'][0:3000])
print ("The Actual length of the article is : ", len(df['article'][200]))
print(df['article'][200])
print ("The length of the summarized article is : ", len(summaries[200]))
print(summaries[200])